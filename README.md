...
- Place all your API keys in a simple `keys.txt` file at the project root.
- Format: Each line as `PROVIDER=your_key`, e.g.:
  ...
  DEEPSEEK_KEY=...
  ```
- Keys are securely loaded and injected per provider.
- No hardcoding—just edit `keys.txt` and restart.
